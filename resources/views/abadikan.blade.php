    ...
    <div class = "grid md:grid-cols-2 xl:mx-20">
        <div class="m-8 px-8">
            ...
            <div class="py-4">
                ...
                <input type="judul" id="judul" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Judul Momen" required>
            </div>

            <div class="py-4">
                <label for="message" class="block mb-2 text-sm font-Roboto font-medium text-gray-900 dark:text-white">Deskripsi</label>
                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tuliskan kisah momen spesialmu disini..."></textarea>
            </div>
        </div>

        <div class="m-8 px-8">
            <label for="gambar" class="block mb-2 text-sm font-Roboto font-medium text-gray-900 dark:text-white">Gambar yang ingin diabadikan</label>
